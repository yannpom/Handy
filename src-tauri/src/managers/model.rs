    ...
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                name: "Distil Large V3 FR".to_string(),
                description: "Optimized for French. 5.9x faster than Whisper Large.".to_string(),
                filename: "ggml-distil-large-v3-fr.bin".to_string(),
                url: Some("https://huggingface.co/eustlb/distil-large-v3-fr-ggml/resolve/main/ggml-distil-large-v3-fr.bin".to_string()),
                size_mb: 1500,
                is_downloaded: false,
                is_downloading: false,
                partial_size: 0,
